...
<head>
    ...
    <!-- ckeditor -->
    <script src="<?php echo e(url('editor/ckeditor/ckeditor.js')); ?>"></script>
    <script src="<?php echo e(url('editor/ckfinder/ckfinder.js')); ?>"></script>
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                     ...
                     <!--    <li>
                        ...
                        <li>
                            <a  style="color: black; font-style: inherit;" href="<?php echo e(url('')); ?>">Về trang chủ</a>
                        </li>                        
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
