...
<html lang = "vi">
	...
	<body class="ot-menu-will-follow">
				...
				<div class="wrapper">
					...
					<div class="header-main">
						...
						<div class="header-main-logo">
							<a href="<?php echo e(url('')); ?>"><img src="<?php echo e(asset('/'.$contact['seo_image'])); ?>" width="100" height="50" alt="No logo" /></a>
						</div>
		...
		<!-- Scripts -->
		<script type="text/javascript" src="<?php echo e(url('home/jscript/jquery-latest.min.js')); ?>"></script>
