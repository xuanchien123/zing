				...
				<div class="content-panel">
					...
					<div class="row">
								...
								<div class="item" data-color-top-slider="#867eef">
									<div class="item-header">
										<a href="<?php echo e(url('chi-tiet/'.$hot['slug'])); ?>">
											...
											<img src="<?php echo e(url('img/news/300x300/'.$hot['newimg'])); ?>" alt="No image" />
										</a>
									</div>
						...
						<div class="visible-xs col-xs-12">
							...
							<?php if($hot): ?>
							<a href="<?php echo e(url('/chi-tiet/'.$hot->slug)); ?>" title="<?php echo e($hot->newsname); ?>"><img class="img-responsive" src="<?php echo e(url('img/news/300x300/'.$hot['newimg'])); ?>" alt="<?php echo e($hot['newimg']); ?>"></a>
							</div>
						...
						<div class="visible-xs col-xs-6 padding4">
							<div class="mobile_img">
								<a href="<?php echo e(url('/chi-tiet/'.$m_item->slug)); ?>" title="<?php echo e($m_item->newsname); ?>"><img class="img-responsive" src="<?php echo e(url('img/news/300x300/'.$m_item['newimg'])); ?>" alt=""></a>
							</div>
							<div class="mobile_title">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<a href="<?php echo e($adverts_center[0]->link); ?>" target="_blank">
										<img src="<?php echo e(url('img/images_bn/'.$adverts_center[0]->img)); ?>" alt="No image" width="100%" style="object-fit: contain;" />
									</a>
									<?php endif; ?>
								</div>
							</div>
		...
		<div class="content-panel">
			<div class="content-panel-body do-space">
				...
				<a href="<?php echo e($adverts_main[0]->link); ?>" target="_blank">
					<img src="<?php echo e(url('img/images_bn/'.$adverts_main[0]->img)); ?>" alt="No image" width="100%" style="object-fit: contain; max-height: 150px; display: block;overflow:hidden; margin-bottom: 20px;" />
				</a>
				<?php endif; ?>
			</div>
		<!-- END .content-panel -->
