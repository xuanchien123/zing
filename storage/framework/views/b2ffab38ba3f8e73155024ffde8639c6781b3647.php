	...
	<div class="visible-xs col-xs-12">
		<div class="mobile_hot_img">
			<a href="<?php echo e(url('/chi-tiet/'.$item->slug)); ?>" title="<?php echo e($item->newsname); ?>">
				<img src="<?php echo e(url('img/news/300x300/'.$item->newimg)); ?> " alt="<?php echo e($item->newimg); ?>">
			</a>
		</div>
...
<?php elseif($i<20): ?>
	<div class="visible-xs col-xs-6 padding4">
		<div class="mobile_img">
			<a href="<?php echo e(url('/chi-tiet/'.$item->slug)); ?>" title="<?php echo e($item->newsname); ?>">
				<img src="<?php echo e(url('img/news/300x300/'.$item->newimg)); ?>" alt="<?php echo e($item->newsname); ?>">
			</a>
		</div>
		<div class="mobile_title">
			<a href="<?php echo e(url('/chi-tiet/'.$item->slug)); ?>" title="<?php echo e($item->newsname); ?>"><h1><?php echo e($item->newsname); ?></h1></a>
...
<?php else: ?> 
	<div class="item">
		<div class="item-header">
			<a href="<?php echo e(url('chi-tiet/'.$item->slug)); ?>" title="<?php echo e($item->newsname); ?>"> 
				<b><?php echo e($count); ?></b>  <img src="<?php echo e(url('img/news/300x300/'.$item->newimg)); ?> " alt="no img" width="50" />
			</a>
		</div>
		<div class="item-content">
		...
		<div class="item">
			<div class="item-header">
				<a href="<?php echo e(url('chi-tiet/'.$item->slug)); ?>">
					<img src="<?php echo e(url('/img/news/100x100/'.$item->newimg)); ?>" alt="no img" width="80" />
				</a>
			</div>
			<div class="item-content">
