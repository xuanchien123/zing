			...
			<div class="item">
				<div class="item-header">
					<a href="<?php echo e(url('chi-tiet/'.$item_lt->slug)); ?>">
						<img src="<?php echo e(url('/img/news/100x100/'.$item_lt->newimg)); ?>" alt="no img" width="80" />
					</a>
				</div>
			...
			<div class="item">
				<div class="item-header">
					...
					<a href="<?php echo e($adverts_bottom[0]->link); ?>">
						<img src="<?php echo e(url('img/images_bn/'.$adverts_bottom[0]->img)); ?>" alt="No image" />
					</a>
					<?php endif; ?>
				</div>
			</div>
		...
		<div class="item">
			<div class="item-header">
				<a href="<?php echo e(url('chi-tiet/'.$item_most->slug)); ?>" title="<?php echo e($item_most->newsname); ?>"> 
					<b><!-- <?php echo e($count); ?> --></b>  <img src="<?php echo e(url('/img/news/100x100/'.$item_most->newimg)); ?>" alt="no img" width="80" />
				</a>
			</div>
			<div class="item-content">
		...
		<div class="item">
			<div class="item-header">
				...
				<a href="<?php echo e($adverts_bottom[1]->link); ?>">
					<img src="<?php echo e(url('img/images_bn/'.$adverts_bottom[1]->img)); ?>" alt="No image" />
				</a>
				<?php endif; ?>
			</div>
		</div>
