...
jQuery(document).ready(function() {
	...
	url = pathname[0]+ pathname[1]+'//'+pathname[2]+'/'+pathname[3];
	jQuery("body").append("<div class='demo-settings'></div>");
	jQuery(".demo-settings").append("<a href='#show-settings' class='demo-button'><i class='fa fa-gear'></i>Cài đặt</a>");
	jQuery(".demo-settings").append("<div class='demo-options'>"+
										"<div class='title'>Cài đặt</div>"+
										"<a href='#demo' rel='font-options' class='option'><img src='"+url+"/public/home/images/demo/image-1.png' class='demo-icon' alt='' /><span>Font Settings</span><font>Change Fonts</font></a>"+
										...
										"<div class='option-box sequal' rel='font-options'>"+
											...
											"</div>"+
										"</div>"+
										"<a href='#demo' rel='color-options' class='option'><img src='"+url+"/public/home/images/demo/image-2.png' class='demo-icon' alt='' /><span>Color Options</span><font>Color schemes</font></a>"+
										...
										"<div class='option-box sequal' rel='color-options'>"+
											...
											"</div>"+
										"</div>"+
										"<a href='#demo' rel='page-header' class='option'><img src='"+url+"/public/home/images/demo/image-6.png' class='demo-icon' alt='' /><span>Change Header</span><font>Choose Header Style</font></a>"+
										"<div class='option-box' rel='page-header'>"+
											...
											"</div>"+
										"</div>"+
										"<a href='#demo' rel='background' class='option'><img src='"+url+"/public/home/images/demo/image-3.png' class='demo-icon' alt='' /><span>Background</span><font>Backgorund textures</font></a>"+
										"<div class='option-box' rel='background'>"+
											"<div alt='background'>"+
												...
												"<a href='#' class='color-bulb' style='background: url("+url+"/public/home/images/background-texture-3.jpg);'>&nbsp;</a>"+
												"<a href='#' class='color-bulb' style='background: url("+url+"/public/home/images/background-texture-1.jpg);'>&nbsp;</a>"+
												"<a href='#' class='color-bulb' style='background: url("+url+"/public/home/images/background-texture-2.jpg);'>&nbsp;</a>"+
												"<a href='#' class='color-bulb' style='background: url("+url+"/public/home/images/background-texture-4.jpg);'>&nbsp;</a>"+
												"<a href='#' class='color-bulb' style='background: url("+url+"/public/home/images/background-texture-5.jpg);'>&nbsp;</a>"+
												"<a href='#' class='color-bulb' style='background-image: url("+url+"/public/home/images/background-photo-1.jpg);background-size: 100%; background-attachment: fixed;'>&nbsp;</a>"+
												"<a href='#' class='color-bulb' style='background-image: url("+url+"/public/home/images/background-photo-2.jpg);background-size: 100%; background-attachment: fixed;'>&nbsp;</a>"+
												"<a href='#' class='color-bulb' style='background-image: url("+url+"/public/home/images/background-photo-3.jpg);background-size: 100%; background-attachment: fixed;'>&nbsp;</a>"+
												"<a href='#' class='color-bulb' style='background-image: url("+url+"/public/home/images/background-photo-4.jpg);background-size: 100%; background-attachment: fixed;'>&nbsp;</a>"+
											"</div>"+
										"</div>"+
										"<a href='#demo' rel='page-width' class='option'><img src='"+url+"/public/home/images/demo/image-4.png' class='demo-icon' alt='' /><span>Change Width</span><font>Boxed or Full-Width</font></a>"+
