...
(function ($) {
	...
	$.fn.coinslider = $.fn.CoinSlider = function (options) {
		...
		var transition = function (el, direction) {
			...
			$(el).css({ 'background-image': 'url("' + images[el.id][imagePos[el.id]] + '")','background-size': 'cover' });
		...
		var init = function (el) {
			...
			// set panel
			$(el).css({
				'background-image': 'url("' + images[el.id][0] + 'no-repeat center center fixed")',
	...
	$.fn.coinslider.defaults = {
		...
		prevText: '<b class="glyphicon glyphicon-chevron-left"></b> ',
		nextText: ' <b class="glyphicon glyphicon-chevron-right"></b> ',
